public class StudentInformation 
{
		 ...
		 public StudentInformation(int rollNo, String studentFirstName, String studentLastName, int age) {
		    ...
		    {
		        StudentInformation s1 = new  StudentInformation(11111, "Paras", "Baid", 30);
		        StudentInformation s2 = new  StudentInformation(11111, "Paras", "Baid", 30);
		        StudentInformation s3 = new  StudentInformation(22222, "Paras", "Baid", 16);
		        StudentInformation s4 = new  StudentInformation(22222, "Paras", "Baid", 16);
